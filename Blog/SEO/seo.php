...
<body>
    ...
    <?php
        ...
        <section> <!--Main image-->
            ...
            <img src="/build/img/seo.webp" alt="Tablet screen with pie graph, cup of coffe and a pen over a table, representing marketing core keys" srcset="">

            <div class="Blog__Section-Title">
                <h1>Search Engine Optimization (SEO) Articles</h1>
            </div>
                ...
                <div class="CardHeader">
                    ...
                    <div class="CardArticle__body">
                        ...
                        <div class="CardArticle__button">
                            <a href="the-ultimate-guide-to-making-your-website-visible-9-seo-infallible-steps">Read More</a>
                        </div>
                    </div>
                </section>
            </div> <!--End card 1-->
