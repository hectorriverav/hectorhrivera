    ...
    <div class="BotomMenu">
        <div class="BotomMenu__Container">
            ...
            <div class="BotomMenu__Navbar">
                ...
                <a href="/about" class="BotomMenu__Navbar--Menu">About</a>
                <a href="/porfolio" class="BotomMenu__Navbar--Menu">Portfolio</a>
                <a href="/blog" class="BotomMenu__Navbar--Menu">Blog</a>
