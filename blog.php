        ...
        <div class="Blog"> <!--Blog Sections-->
            ...
            <section>
                <div class="Blog__Sections__Text"> <!--Last Paragraph-->
                    ...
                    <p>Fill out the form below, with your email and name. </p>
                </div>
            </section>

            <!-- Begin Mailchimp Signup Form whitout name -->
            <?php
            include "./includes/templates/mailChimp-signupForm-wo_name.php"
            ?>
